...
condition <- label <- as.factor(labelsProx$fos)
...
head(resOrdered)
resOrdered <- na.exclude(resOrdered)


#save(list=c("resOrdered"),file="~/Documents/SalkProjects/ME/ShortLongSingature/raw/SL_Deseq_Res.rda")
load("~/Documents/SalkProjects/ME/ShortLongSingature/raw/SL_Deseq_Res.rda")
