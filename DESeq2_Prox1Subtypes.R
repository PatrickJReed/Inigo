...
load(file="~/Documents/SalkProjects/ME/ShortLongSingature/SLSig_R/DESeq2_Prox1Subtypes.rda")
####################################################
...
####################################################
condition <- label <- as.factor(Hgroups)

normal <- as.character(1)
...
#save(list=c("resOrdered"),file="~/Documents/SalkProjects/ME/ShortLongSingature/SLSig_R/DESeq2_Prox1Subtypes.rda",compress=TRUE)
